...
public class CheckIn {
    ...
    private List<SimpleQuestion> simpleQuestions = new ArrayList<SimpleQuestion>();
    private List<MultipleChoiceQuestion> multipleChoiceQuestions = new ArrayList<MultipleChoiceQuestion>();
